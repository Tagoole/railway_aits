    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('student', 'Student'), ('lecturer', 'lecturer'), ('head_of_department', 'Head of Department'), ('academic_registrar', 'academic_registrar')], default='student', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lecturer', models.ForeignKey(limit_choices_to={'role': 'lecturer'}, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='lecturer', to=settings.AUTH_USER_MODEL)),
                ('registrar', models.ForeignKey(limit_choices_to={'role': 'academic_registrar'}, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registrar', to=settings.AUTH_USER_MODEL)),

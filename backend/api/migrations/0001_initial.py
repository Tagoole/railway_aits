<<<<<<< HEAD
# Generated by Django 5.1.6 on 2025-03-12 08:04
=======
# Generated by Django 5.1.6 on 2025-03-14 10:42
>>>>>>> 21dcf20c7404fe31dd92686f865ab4b4c1a70961
...
<<<<<<< HEAD
                ('role', models.CharField(choices=[('student', 'Student'), ('lecturer', 'lecturer'), ('academic_registrar', 'academic_registrar')], default='student', max_length=30)),
                ...
                ('year_of_study', models.CharField(blank=True, choices=[('1st_year', '1st Year'), ('2nd_year', '2nd Year'), ('3rd_year', '3rd Year'), ('4th_year', '4th Year'), ('5th_year', '5th Year')], max_length=20, null=True)),
...
>>>>>>> 21dcf20c7404fe31dd92686f865ab4b4c1a70961
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_units', models.ManyToManyField(related_name='course_units', to='api.course_unit')),
            ],
        ),
        migrations.CreateModel(
            name='Issue',
...
<<<<<<< HEAD
                ...
                ('course_unit', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.course_unit')),
=======
                ('image', models.ImageField(blank=True, null=True, upload_to='issues/')),
                ('status', models.CharField(choices=[('pending', 'Pending'), ('resolved', 'Resolved'), ('in_progress', 'In Progress')], default='pending', max_length=30)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
...
=======
        ...
        migrations.AddField(
            ...
            name='program',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='programs', to='api.program'),
>>>>>>> 21dcf20c7404fe31dd92686f865ab4b4c1a70961
        ),
    ]
